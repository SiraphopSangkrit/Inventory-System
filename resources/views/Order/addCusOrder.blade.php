                    ...
                    <div class="ml-12 mt-8">
                        ...
                        <div class="mt-6">
                            ...
                            <form>
                                ...
                                <div class="grid gap-6 mb-6 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative max-w-sm">
                                            ...
                                            <input datepicker datepicker-autohide id="datepicker-autohide"
                                                type="text"
                                ...
                                <a href="{{ route('order.create.detail') }}" type="button"
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">บันทึกและเพิ่มรายการสินค้าต่อ</a>
                            </form>
                        </div>
